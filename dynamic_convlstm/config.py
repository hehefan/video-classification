...
tf.app.flags.DEFINE_integer("convlstm_kernel_side", 3, "Side length of ConvLSTM kernel.")
tf.app.flags.DEFINE_integer("convlstm_output_channels", 512, "Number of ConvLSTM output channels.")

tf.app.flags.DEFINE_integer("conv_kernel_side", 3, "Side length of Conv kernel.")
tf.app.flags.DEFINE_integer("conv_output_channels", 512, "Number of Conv output channels.")

tf.app.flags.DEFINE_integer("feature_side", 28, "Side length of frame feature.")
tf.app.flags.DEFINE_integer("feature_size", 256, "Size of frame feature.")
